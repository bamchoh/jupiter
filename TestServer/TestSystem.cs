...
{
    public interface ITestSystemCallback
    {
        void OnDataChange(
    ...
    {
        public TestSystem(ITestSystemCallback callback, NamespaceTable namespaceUris, StringTable serverUris)
        {
            m_callback = callback;
        ...
        */
        ...
        private ITestSystemCallback m_callback;
