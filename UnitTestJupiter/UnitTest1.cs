...
namespace UnitTestJupiter
{
    ...
    public class UnitTest1
    {
        ...
        [DataRow(float.MinValue, FormatType.FLOAT, "-3.402823E+38")]
        [DataRow(float.MaxValue, FormatType.FLOAT, "3.402823E+38")]
        [DataRow(float.Epsilon, FormatType.FLOAT, "1.401298E-45")]
        [DataRow((float)0, FormatType.FLOAT, "0")]
        [DataRow((float)1.234, FormatType.FLOAT, "1.234")]
        [DataRow((float)-2.345, FormatType.FLOAT, "-2.345")]
        [DataRow(float.PositiveInfinity, FormatType.FLOAT, "∞")]
        [DataRow(float.NegativeInfinity, FormatType.FLOAT, "-∞")]
        ...
        [DataRow(double.MinValue, FormatType.FLOAT, "-1.79769313486232E+308")]
        [DataRow(double.MaxValue, FormatType.FLOAT, "1.79769313486232E+308")]
        [DataRow(double.Epsilon, FormatType.FLOAT, "4.94065645841247E-324")]
        ...
        [DataRow(double.PositiveInfinity, FormatType.FLOAT, "∞")]
        [DataRow(double.NegativeInfinity, FormatType.FLOAT, "-∞")]
        ...
        [DataRow("-4.402823E+38", FormatType.FLOAT)]
        [DataRow("-3.402823E+39", FormatType.FLOAT)]
        [DataRow("-NaN", FormatType.FLOAT)]
        [DataRow("∞", FormatType.FLOAT)]
        [DataRow("-∞", FormatType.FLOAT)]
        [DataTestMethod]
        ...
        [DataRow("-2.797693134862315708145274237317043567981e+308", FormatType.FLOAT)]
        [DataRow("-1.797693134862315708145274237317043567981e+309", FormatType.FLOAT)]
        [DataRow("-NaN", FormatType.FLOAT)]
        [DataRow("∞", FormatType.FLOAT)]
        [DataRow("-∞", FormatType.FLOAT)]
        [DataTestMethod]
